...
const COUNTRY_CURRENCIES: Record<string, string> = {
  china: 'CNY', 中国: 'CNY', cn: 'CNY',
  malaysia: 'MYR', 马来西亚: 'MYR', my: 'MYR',
  singapore: 'SGD', 新加坡: 'SGD', sg: 'SGD',
  thailand: 'THB', 泰国: 'THB', th: 'THB',
  indonesia: 'IDR', 印度尼西亚: 'IDR', id: 'IDR',
  philippines: 'PHP', 菲律宾: 'PHP', ph: 'PHP',
  japan: 'JPY', 日本: 'JPY', jp: 'JPY',
  'south korea': 'KRW', korea: 'KRW', 韩国: 'KRW', kr: 'KRW',
  'united states': 'USD', usa: 'USD', 美国: 'USD', us: 'USD',
  'united kingdom': 'GBP', 英国: 'GBP', gb: 'GBP',
  australia: 'AUD', 澳大利亚: 'AUD', au: 'AUD',
  austria: 'EUR', 奥地利: 'EUR', at: 'EUR',
  belgium: 'EUR', 比利时: 'EUR', be: 'EUR',
  croatia: 'EUR', 克罗地亚: 'EUR', hr: 'EUR',
  cyprus: 'EUR', 塞浦路斯: 'EUR', cy: 'EUR',
  estonia: 'EUR', 爱沙尼亚: 'EUR', ee: 'EUR',
  finland: 'EUR', 芬兰: 'EUR', fi: 'EUR',
  france: 'EUR', 法国: 'EUR', fr: 'EUR',
  germany: 'EUR', 德国: 'EUR', de: 'EUR',
  greece: 'EUR', 希腊: 'EUR', gr: 'EUR',
  ireland: 'EUR', 爱尔兰: 'EUR', ie: 'EUR',
  italy: 'EUR', 意大利: 'EUR', it: 'EUR',
  latvia: 'EUR', 拉脱维亚: 'EUR', lv: 'EUR',
  lithuania: 'EUR', 立陶宛: 'EUR', lt: 'EUR',
  luxembourg: 'EUR', 卢森堡: 'EUR', lu: 'EUR',
  malta: 'EUR', 马耳他: 'EUR', mt: 'EUR',
  netherlands: 'EUR', 荷兰: 'EUR', nl: 'EUR',
  portugal: 'EUR', 葡萄牙: 'EUR', pt: 'EUR',
  slovakia: 'EUR', 斯洛伐克: 'EUR', sk: 'EUR',
  slovenia: 'EUR', 斯洛文尼亚: 'EUR', si: 'EUR',
  spain: 'EUR', 西班牙: 'EUR', es: 'EUR',
  hong kong: 'HKD', 中国香港: 'HKD', hk: 'HKD',
};
const COUNTRIES = [
